...
Revision ID: 8f8b96d4714d
Revises: 8a18c29485d4
Create Date: 2024-11-13 13:59:58.250842
...
revision: str = '8f8b96d4714d'
down_revision: Union[str, None] = '8a18c29485d4'
...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.CHAR(length=36), nullable=False, comment='ユーザーID (UUID)'),
    ...
    sa.Column('group_id', sa.CHAR(length=36), nullable=False, comment='グループID (UUID)'),
    sa.Column('group_name', sa.String(length=50), nullable=False, comment='グループ名'),
    sa.Column('parent_group_id', sa.CHAR(length=36), nullable=True, comment='親グループID (UUID)'),
    sa.Column('created_at', sa.TIMESTAMP(), nullable=True, comment='作成日時'),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True, comment='更新日時'),
    sa.Column('deleted_at', sa.TIMESTAMP(), nullable=True, comment='削除日時'),
    ...
    sa.Column('evaluator_id', sa.CHAR(length=36), nullable=False, comment='評価者ID (UUID)'),
    sa.Column('group_id', sa.CHAR(length=36), nullable=False, comment='グループID (UUID)'),
    ...
    sa.Column('evaluator_id', sa.CHAR(length=36), nullable=False, comment='評価者ユーザーID (UUID)'),
    sa.Column('group_id', sa.CHAR(length=36), nullable=False, comment='グループID (UUID)'),
    ...
    sa.Column('report_id', sa.CHAR(length=36), nullable=False, comment='レポートID (UUID)'),
    sa.Column('user_id', sa.CHAR(length=36), nullable=False, comment='作成者ユーザーID (UUID)'),
    ...
    sa.Column('history_id', sa.Integer(), autoincrement=True, nullable=False, comment='評価履歴ID'),
    sa.Column('eval_id', sa.Integer(), nullable=False, comment='評価ID'),
    sa.Column('user_id', sa.CHAR(length=36), nullable=False, comment='評価を行ったユーザーID (UUID)'),
    sa.Column('target_user_id', sa.CHAR(length=36), nullable=False, comment='評価されたユーザーID (UUID)'),
    sa.Column('score', sa.Integer(), nullable=True, comment='評価スコア'),
    sa.Column('comment', sa.Text(), nullable=True, comment='評価コメント'),
    sa.Column('created_at', sa.TIMESTAMP(), nullable=True, comment='作成日時'),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True, comment='更新日時'),
    ...
    sa.Column('history_id', sa.Integer(), autoincrement=True, nullable=False, comment='履歴ID'),
    sa.Column('viewer_id', sa.CHAR(length=36), nullable=False, comment='閲覧者ID (UUID)'),
    sa.Column('viewed_user_id', sa.CHAR(length=36), nullable=False, comment='閲覧対象ユーザーID (UUID)'),
    sa.Column('created_at', sa.TIMESTAMP(), nullable=True, comment='作成日時'),
    sa.Column('view_date', sa.TIMESTAMP(), nullable=True, comment='閲覧日時'),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True, comment='更新日時'),
    sa.Column('deleted_at', sa.TIMESTAMP(), nullable=True, comment='削除日時'),
    sa.ForeignKeyConstraint(['viewed_user_id'], ['user.user_id'], ),
    sa.ForeignKeyConstraint(['viewer_id'], ['user.user_id'], ),
    sa.PrimaryKeyConstraint('history_id')
    )
    op.create_table('report_evaluation_history',
    sa.Column('history_id', sa.Integer(), autoincrement=True, nullable=False, comment='評価履歴ID'),
    sa.Column('eval_id', sa.Integer(), nullable=False, comment='評価ID'),
    sa.Column('user_id', sa.CHAR(length=36), nullable=False, comment='評価者ユーザーID (UUID)'),
    sa.Column('report_id', sa.CHAR(length=36), nullable=False, comment='レポートID (UUID)'),
    sa.Column('score', sa.Integer(), nullable=True, comment='評価スコア'),
    sa.Column('comment', sa.Text(), nullable=True, comment='評価コメント'),
    sa.Column('created_at', sa.TIMESTAMP(), nullable=True, comment='作成日時'),
