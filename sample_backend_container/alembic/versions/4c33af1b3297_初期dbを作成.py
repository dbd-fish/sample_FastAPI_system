...
Revision ID: 4c33af1b3297
Revises: 
Create Date: 2024-11-17 00:10:11.489059
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='作成日時'),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='更新日時'),
    ...
    sa.Column('search_date', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='検索日時'),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='作成日時'),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='更新日時'),
    sa.Column('deleted_at', sa.TIMESTAMP(), nullable=True, comment='削除日時'),
    ...
    sa.Column('view_date', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='閲覧日時'),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='作成日時'),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='更新日時'),
    sa.Column('deleted_at', sa.TIMESTAMP(), nullable=True, comment='削除日時'),
